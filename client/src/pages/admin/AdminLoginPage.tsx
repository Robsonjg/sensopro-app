...
export default function AdminLoginPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await registroMutation.mutateAsync({ email, senha, nome });
      ...
      <Card className="w-full max-w-md shadow-lg">
        <div className="p-8">
          ...
          <form onSubmit={showRegister ? handleRegister : handleLogin} className="space-y-4">
            ...
            {/* Botão com CSS inline garantido */}
            <button
              type="submit"
              disabled={isLoading}
              style={{
              ...
              onMouseEnter={(e) => {
                if (!isLoading) e.currentTarget.style.backgroundColor = '#c91b4a';
              }}
              onMouseLeave={(e) => {
                if (!isLoading) e.currentTarget.style.backgroundColor = '#e63e6d';
              }}
            >
              {isLoading ? (
          ...
          <div className="mt-6 text-center">
            <button
              ...
              onMouseEnter={(e) => e.currentTarget.style.color = '#c91b4a'}
              onMouseLeave={(e) => e.currentTarget.style.color = '#e63e6d'}
            >
