...
import { ativarExperimento, createAmostra, createAtributo, createAdmin, createExperimento, createSessao, deleteAmostra, deleteAtributo, deleteExperimento, desativarExperimento, finalizarSessao, getAdminByEmail, getAdminById, getDashboardData, getExperimentoById, getExperimentoBySlug, getRespostasCompletas, listAdmins, listAmostras, listAtributos, listExperimentos, updateAmostra, updateAtributo, updateExperimento, upsertResposta, promoteAdminByEmail, deactivateAdminByEmail, acceptConvite, createConvite, getConviteByCode, } from "./db.js";
...
export const appRouter = router({
    ...
    avaliacao: router({
        getExperimento: publicProcedure
            ...
            if (!exp || !exp.ativo)
                throw new TRPCError({ code: "NOT_FOUND", message: "Experimento não encontrado ou inativo" });
